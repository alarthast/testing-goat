...
class ItemValidationTest(FunctionalTest):
    def test_cannot_add_empty_list_items(self):
        ...
        self.wait_for_element(By.CSS_SELECTOR, "#id_text:invalid")

        # She starts typing some text for the new item and the error disappears
        self.get_item_input_box().send_keys("Purchase milk")
        self.wait_for_element(By.CSS_SELECTOR, "#id_text:valid")
    ...
    def test_cannot_add_duplicate_items(self):
        ...
        invalid_feedback = self.wait_for_element(By.CSS_SELECTOR, ".invalid-feedback")
